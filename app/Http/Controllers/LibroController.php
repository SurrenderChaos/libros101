...
class LibroController extends Controller
{
    ...
    {
        //
        $this->validate($request,[ 'nombre'=>'required', 'resumen'=>'required', 'npagina'=>'required', 'edicion'=>'required', 'autor'=>'required', 'npagina'=>'required', 'precio'=>'required', 'year'=>'required']);
    ...
    public function changeYear(Request $request, $id)    {
